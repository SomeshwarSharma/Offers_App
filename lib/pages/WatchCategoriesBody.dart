...
class WatchCategoriesBody extends StatelessWidget {
  @override
          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                height: 100.0,
                child: Image(
                  image: AssetImage("assets/images/AUDEMARSPIGUET.png"),
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: RaisedButton(onPressed: (){
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => AudemarsPiguet())
                      );
                    },
                      child: Text(
                        'View Details',
