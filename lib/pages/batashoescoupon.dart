...
class batashoescuponpage extends StatefulWidget {
  @override
  _batashoescuponpageState createState() => _batashoescuponpageState();


}

class _batashoescuponpageState extends State<batashoescuponpage> {  @override
                  ...
                  children: [
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Text('''50% OFF on all ladies sandals''',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 20.0,
                            color: Colors.deepPurple,
