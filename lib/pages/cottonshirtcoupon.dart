...
class cottonshirtcuponpage extends StatefulWidget {
  @override
  _cottonshirtcuponpageState createState() => _cottonshirtcuponpageState();


}

class _cottonshirtcuponpageState extends State<cottonshirtcuponpage> {  @override
                  ...
                  children: [
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Text('''40% off on all Ironless Shirts''',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 20.0,
                            color: Colors.deepPurple,
